...
{
  private JFrame window = new JFrame("SIF8020 - Bildedatabase - DB3");  // Programvinduet
  ...
  public static void main(String args[])
  {
    try {
      ...
      //new DB3(DriverManager.getConnection("jdbc:oracle:thin:@elefant.idi.ntnu.no:1521:elefant",
      //                                    "brukernavn", "passord"));
  ...
  public DB3(final Connection con) throws Exception
  {
    ...
    JLabel label1 = new JLabel("Bilder");
    JLabel label2 = new JLabel("Utgaver");
    JLabel label3 = new JLabel("nuestra conexion");
    //JLabel label3 = new JLabel("S�kDriverManager.getConnection("jdbc:oracle:thin:@elefant.idi.ntnu.no:1521:elefant",
			      //                                    "brukernavn", "passord")eord");
